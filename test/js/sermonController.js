// Create your app with 'videogular' dependency
'use strict';
var sermonApp = angular.module('sermonApp', [ "ngRoute","ngSanitize", "com.2fdevs.videogular", 
			"com.2fdevs.videogular.plugins.controls",
            "com.2fdevs.videogular.plugins.overlayplay",
            "com.2fdevs.videogular.plugins.poster",
            "com.2fdevs.videogular.plugins.buffering"]);
    
	sermonApp.controller('sermonController',["$sce",'$scope', '$routeParams', '$http', function ($sce,scope,routeParams,http) {
         
		$http.get('messagesData.json').success(function(data) {
			$scope.messages = data;
		}); 
