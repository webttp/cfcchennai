...
function initApp($scope, $filter, $http) {
  ...
  function getProject(){
			...
			*/
			...
			var arr = [];
			$http.post("db.php?action=get_product").success(function(data){
				$.each(data, function(i, item) {
				alert(item.prod_name);
					arr.push({"id":"sss"});
				});
			});
			console.log(arr);
    ...
    <table class="table table-striped table-bordered">
      <tbody><tr>
       <th class="id"><a ng-click="sort_by('id')">Id <i class="fa fa-sort"></i></a></th>
        <th class="name"><a ng-click="sort_by('prod_name')">Name <i class="fa fa-sort"></i></a></th>
