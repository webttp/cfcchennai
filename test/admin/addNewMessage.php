...
<?php 
 ...
 -				$date  = "$sparts[2]-$sparts[0]-$sparts[1]";
				...
				$InsColumnVal = array("date"=>$date,"location"=>$location,"title"=>$messagetitle,"speaker"=>$speaker,"messagetype"=>$messagetype,"videokey"=>$videokey."?rel=0&autoplay=0&enablejsapi=1&origin=http://cfcchennai.church","audiokey"=>$audiokey.".mp3","uploadedby"=>$loginid,"uploadeddate"=>$currentdt);
