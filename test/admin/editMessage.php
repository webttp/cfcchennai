...
?>					
					...
					<select class="form-control"  id="speaker"  name="speaker" required>
						...
						<option ng-option <?php if($fetch['0']['speaker']=='Prakasam'){echo "selected=selected";} ?> value="Prakasam">Prakasam</option>
						<option ng-option <?php if($fetch['0']['speaker']=='Micheal'){echo "selected=selected";} ?> value="Micheal">Micheal</option>
						<option ng-option <?php if($fetch['0']['speaker']=='Jesudoss'){echo "selected=selected";} ?> value="Jesudoss">Jesudoss</option>
						<option <?php if($fetch['0']['speaker']=='Johnrajan'){echo "selected=selected";} ?> ng-option value="Johnrajan">Johnrajan</option>
					</select>
					</div>
					</div>
					<div class= "form-group">
