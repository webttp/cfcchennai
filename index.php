    ...
    <div class="row">
					<div class="col-md-1 col-sm-1 col-xs-1 cfcc-logo">
						<a href="http://www.cfcindia.com/"> 
						 <img alt="Logo" class="img-responsive main-logo" src="images/Cfc_Chennai_Logo.png" alt="Chennai-CFC">
						</a>
					</div>
					<div class="col-md-11 col-sm-11 col-xs-11 cfcc-verse">
                      ...
                      <em>And he who does not take his cross and follow after Me is not worthy of Me </br> (Matthew 10:38) </em>
						...
						<div class="hidden-md hidden-lg hidden-sm col-xs-11">
...
<div class="spinner-container" style="display:none;">
	...
	<div id="footer_container" class="footer-container">
		<div class="footer-menu">
			<div class="container footer-area">
				<div class="col-md-4 col-sm-4 col-xs-12 footer-section-1">
					...
					<ul>
						...
						<li>Ph : 9710925425, 9840154586</li>
					</ul>
				</div>
			...
			<div class="cfcc-bottom-footer">All rights reserved @ cfcchennai.church 2016</div>
		</div>
  </div>
</footer>
