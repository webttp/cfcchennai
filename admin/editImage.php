...
?>		<div class="container">
            ...
            <div class="row">
				<div class="col-md-12">
					...
					<div class="col-md-4">
					<input name="uploadedfile" value="<?php echo $fetch['0']['imgsrc']?>" type="file" id="uploadImage" class="target" /> 
					<span><?php echo $fetch['0']['imgsrc']?></span>
					<!--<img src="imagebank/thumbnail/<?php echo $fetch['0']['imgsrc']?>">-->
